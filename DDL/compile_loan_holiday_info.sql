CREATE PROCEDURE compile_loan_holiday_info()
    LANGUAGE plpgsql
AS
$$
DECLARE
...
CREATE TABLE IF NOT EXISTS dm.loan_holiday_info AS
WITH
    deal AS (
        SELECT deal_rk
...
ALTER PROCEDURE compile_loan_holiday_info() OWNER TO airflow;
