CREATE OR REPLACE PROCEDURE dm.upsert_account_balance_turnover()
    LANGUAGE plpgsql
AS
$$
DECLARE
...
BEGIN
    ...
    FROM ab
    ON CONFLICT (account_rk, effective_date)
        DO UPDATE SET
                      currency_name = EXCLUDED.currency_name,
                      department_rk = EXCLUDED.department_rk,
                      account_in_sum = EXCLUDED.account_in_sum,
                      account_out_sum = EXCLUDED.account_out_sum;
